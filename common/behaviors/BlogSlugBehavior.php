 ...
 * @since 2.0
 */
class BlogSlugBehavior extends \yii\behaviors\AttributeBehavior
{
    /**
    ...
    public function init()
    {
        ...
        if (empty($this->attributes)) {
            $this->attributes = [
                BaseActiveRecord::EVENT_BEFORE_INSERT => [$this->slug],
            ];
        }
    }
    ...
    {
        if ($this->value === null) {
            return \str_replace(' ', '-', \strtolower($this->owner->name));
        }
